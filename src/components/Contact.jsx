        ...
        <div className="grid md:grid-cols-2 place-items-center">
            <div>
                <div className="text-gray-300 my-3">
                    ...
                    Hi, I'm Neo—a passionate web developer and a dedicated student with a strong interest in backend development. I enjoy building scalable and efficient server-side applications using modern frameworks and databases. Always eager to learn and solve complex challenges, I strive to create seamless and high-performing web solutions.
                    </p>
                </div>
            ...
            <input
                ...
                name="name"
                className="mb-2 w-full text-gray-50 rounded-md border border-purple-600 py-2 pl-2 pr-4"
            />
            <input
              type="email"
              id="email"
